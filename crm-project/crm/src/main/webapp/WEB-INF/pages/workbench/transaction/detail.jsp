...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${stageList}" var="stageObj">
			<c:if test="${stageObj.orderNo<toolMap.tranStageId}">
				<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="${stageObj.value}" style="color: #90F790;"></span>
				-----------
			</c:if>
			<c:if test="${stageObj.orderNo==toolMap.tranStageId}">
				<span class="glyphicon glyphicon-map-marker mystage" data-toggle="popover" data-placement="bottom" data-content="${stageObj.value}" style="color: #90F790;"></span>
				-----------
			</c:if>
			<c:if test="${stageObj.orderNo>toolMap.tranStageId}">
				<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="${stageObj.value}"></span>
				-----------
			</c:if>
		</c:forEach>
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 70px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;">${transaction.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${transaction.editTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
	...
	<div style="position: relative; top: 100px; left: 40px;">
        ...
        <div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;" >
                ...
                <font color="gray">交易</font> <font color="gray">-</font> <b>${activity.name}</b> <small editNameSmall="edit" style="color: gray;">
