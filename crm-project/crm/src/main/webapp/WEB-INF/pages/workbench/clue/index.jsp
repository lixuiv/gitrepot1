			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<%--主内容展示 -->
						<tr>
							<td><input type="checkbox" /></td>
							<%--><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detail.jsp';">李四先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
                        ...
                        <tr class="active">
                            <td><input type="checkbox" /></td>
                            <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/showClueDetail?id=059bb99b90184fc0b89950091ca4b663';">秋水先生</a></td>
                            <td>秋水公司</td>
                            <td>010-84846003</td>
                            <td>12345678901</td>
                            <td>广告</td>
