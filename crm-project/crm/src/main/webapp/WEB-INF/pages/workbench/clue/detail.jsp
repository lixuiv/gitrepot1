...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#relationClueAndActivity").click(function () {
			var clueId="${clue.id}"
			...
			//获取市场活动id打包成为字符串 ?activityId=123&activityId=123&...
			var ids=""
			...
			ids+="clueId="+clueId
			$.ajax({
				url:'workbench/clue/saveClueActivityRelationByIds',
				type:'POST',
				data:ids,
				dataType:'json',
				success:function (data) {
		...
		//give deleteRelationBtn a function //delete ralation
		$("#relationActivitiesTbody").on("click","a",function () {
			var activityId = $(this).attr("activityId");
			var clueId="${clue.id}"
			$.ajax({
				url:'workbench/clue/deleteActivityRelationForClue',
				type:'POST',
				data:{
	...
	queryActivityRelation = function (){
		...
		$.ajax({
			url:'workbench/clue/queryActivityByClueId',
			type:'POST',
			data:{id:"${clue.id}"},
			dataType:'json',
			success:function (data){
				if (data.code=="1"){
					...
					$("#relationActivitiesTbody").html(htmlStr)
				}else{
					alert("查询失败...")
				}
			}
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input id="searchActivityForRelation" type="text" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="relationClueAndActivity">关联</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/toConvert?id=${clue.id}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<c:forEach items="${clueRemarkList}" var="remark">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}-${clue.company}</b> <small style="color: gray;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>嘿嘿嘿！</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}-${clue.company}</b> <small style="color: gray;"> ${clue.createTime}由${clue.fullname}创建</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
		...
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table class="table table-hover" style="width: 900px;">
					...
					<tbody id="relationActivitiesTbody">
						<%--
						<tr>
							<td>发传单</td>
							<td>2020-10-10</td>
			...
			<div>
				<a href="javascript:void(0);" id="activityRelationA" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
